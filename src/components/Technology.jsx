...
const Technology = ({ technology, createdBy, img, id, btn1, btn2, status }) => {
  return (
    <div className=" w-80 h-96 bg-white rounded-2xl flex flex-col justify-evenly items-center shadow-purple-600 shadow-md border-solid border-purple-700 border-4 mb-10 mx-2">
      <img src={img} alt="" className="w-40 h-40" />
      <div className=" w-full flex flex-col justify-center items-center">
        <h3 className=" font-bold text-4xl">{technology}</h3>
